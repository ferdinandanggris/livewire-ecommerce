			...
			<div class=" main-content-area">
				...
				<div class="wrap-iten-in-cart">
					...
					<div class="alert alert-succes">
						<strong>Berhasil</strong> {{Session::get('succes_message')}}
					</div>
					@endif
					@if (Cart::count() > 0)
				...
				<div class="summary">
					...
					<div class="checkout-info">
						...
						<a class="link-to-shop" href="/shop">lanjut belanja<i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
					</div>
					<div class="update-clear">
						<a class="btn btn-clear" href="#">hapus keranjang</a>
						<a class="btn btn-update" href="#">tambah keranjang</a>
					</div>
				</div>

				<div class="wrap-show-advance-info-box style-1 box-in-site">
					<h3 class="title-box"> Produk </h3>
						...
						<div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
							...
							<div class="product product-style-2 equal-elem ">
								...
								<div class="product-info">
									<a href="#" class="product-name"><span>laptop asus</span></a>
									<div class="wrap-price"><span class="product-price">Rp.4.500.000</span></div>
								</div>
							</div>
							...
							<div class="product product-style-2 equal-elem ">
								...
								<div class="product-info">
									...
									<div class="wrap-price"><ins><p class="product-price">Rp.150.000</p></ins> <del><p class="product-price">Rp.250.000</p></del></div>
								</div>
							</div>
							...
							<div class="product product-style-2 equal-elem ">
								...
								<div class="product-info">
									<a href="#" class="product-name"><span>Radiant-360 R6 Wireless Omnidirectional Speaker [White]</span></a>
									<div class="wrap-price"><span class="product-price">Rp.250.000</span></div>
								</div>
							</div>
